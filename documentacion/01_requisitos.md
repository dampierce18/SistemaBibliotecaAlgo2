...
* **RF-03: Gestión de Libros (CRUD)**
    ...
    * El sistema debe tener una función para Editar un libro (solo Administrador).
        * *Estado actual: No implementado (muestra "Funcionalidad... en desarrollo")*.
...
* **RNF-05: Dependencias:** El proyecto debe gestionar sus dependencias usando **Maven**. La única dependencia externa principal es `sqlite-jdbc`.

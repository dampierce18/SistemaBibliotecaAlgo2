...
* **Componentes clave:**
    ...
    * `PanelLibros.java`, `PanelUsuarios.java`, `PanelPrestamos.java`: `JPanel` que definen cada módulo.
...
* **Componentes clave:**
    ...
    * `ControladorLibros.java`, `ControladorPrestamos.java`: Contienen la lógica para cada módulo (ej. la validación de stock disponible está en `ControladorPrestamos`).
...
* **Componentes clave:**
    * `LibroDAO.java`, `UsuarioDAO.java`, `PrestamoDAO.java`.
